...
const generateMaze = (width, height) => {
  ...
  const maze = Array(height).fill(null).map(() => Array(width).fill("wall"));
        ...
        <div className="space-y-4">
          ...
          <Card>
            <CardContent className="p-2">
              {showMindfulness ? (
                <div className="bg-purple-50 dark:bg-purple-950 p-6 rounded-md text-center text-white space-y-6">
